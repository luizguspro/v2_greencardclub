          ...
          <div className="container mx-auto px-6">
            <div className="max-w-5xl mx-auto">
              ...
              >
                ...
                {/* CTAs - Organizados em duas linhas */}
                <div className="space-y-4">
                  {/* Linha Principal - Ações de Carteirinha */}
                  ...
                  {/* Linha Secundária - Links de Acesso */}
                  <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <Link
                      href="/login"
                      className="text-greencard-primary hover:text-greencard-secondary font-semibold transition-colors flex items-center gap-1"
                    >
                ...
                >
                  ...
                  <div className="relative w-[420px] h-[270px] bg-gradient-to-br from-[#0a5a42] via-[#084734] to-[#063d2b] rounded-2xl shadow-2xl overflow-hidden">
                      ...
                      <div className="flex gap-6 flex-1">
                        ...
                        <div className="flex-1 flex flex-col justify-center">
                          ...
                          <div className="mt-3">
                            ...
                            <p className="text-white font-mono text-sm">CANNABIS</p>
                          </div>
                        </div>
                    ...
                    <div className="absolute bottom-6 left-6 w-12 h-10 bg-gradient-to-br from-yellow-400/80 to-yellow-600/80 rounded-md">
                      <div className="w-full h-full rounded-md border border-yellow-700/30" style={{
                        backgroundImage: `
